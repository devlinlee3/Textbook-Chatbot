This is an AI chatbot to chat with an uploaded textbook. Utilized Llama 3.1 as the LLM, Langchain for text retrieval and vector embeddings, and Streamlit for UI. 
